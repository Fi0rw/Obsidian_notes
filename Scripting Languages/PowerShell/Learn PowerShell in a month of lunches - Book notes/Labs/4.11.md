...
- `New-Item -Name "MyFolder1" -Path C:\Practice\PS -Type Directory`
- `New-Item -Name "MyFolder2" -Path C:\Practice\PS -Type Directory` 
...
- `Remove-Item -Path C:\Practice\PS\MyFolder*`